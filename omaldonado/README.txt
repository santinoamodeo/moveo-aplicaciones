...
Luego encontramos un archivo llamada "Final.py" dentro de este se encuentra importado el modulo de del programa anterior, dentro de "Final.py" se ejecutan las funciones 

Primero debemos entender el funcionamiento de MQTT y establecer un broker, en mi caso utilice uno publico de Google, una vez teniendo eso establecemos dentro del codigo 
el Topic en donde vayamos a establecer la comunicacion, con el celular debemos conectarnos mediante la aplicacion MQTT al broker y luego al Topic como publicador (envia mensaje), mientras
